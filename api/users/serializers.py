...
class UserRawSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('id', 'host', 'url', 'github', 'first_name', 'last_name', 'email', 'bio', 'userType', 'approved')
...
class UserSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ('id', 'host', 'displayName', 'url', 'github', 'firstName', 'lastName', 'email', 'bio', 'userType', 'approved')
